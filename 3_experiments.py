...
wandb.init(project='Gland_SegNorm', config='config/config.yaml')
config = wandb.config
...
colon_weights_path = "/ruta/a/tu/best_dice_colon.pth"
    ...
    if mode == 'baseline1':
        ...
        for e in range(1, epochs + 1):
            ...
            if val_dice > best_val_dice:
                ...
                torch.save(model.state_dict(), f"best_finetune_epoch{e}.pth")
